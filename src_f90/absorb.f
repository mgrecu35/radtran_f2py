      subroutine absorb(freq,temp,pres,relhum,kabs)
      real freq, temp, pres, relhum, kabs
      call absorbr(freq,temp,pres,relhum,0.0,kabs)
      end
      
      subroutine absorbr(freq,temp,pres,relhum,water,kabs)
 
      real *4  kabs, kabs_H2O, kabs_O2, kabs_N2, kabs_clw
